...
class DatabaseManager:
    ...
    def insert_word(self, word):
        ...
        insert_query = '''
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        '''
        self.execute_and_commit(insert_query, (insert_index, word, conju_list, pronun_list))
    ...
    def delete_word(self, word):
        ...
        word_id = result[0]
        self.execute_and_commit("DELETE FROM words WHERE word = ?", (word,))
